...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if (orderItem.getProduct().getAvailability() + oldQuantity < quantity) {
            JOptionPane.showMessageDialog(this, "Please check product availability.");
            return;
        }

        orderItem.getProduct().setAvailability(orderItem.getProduct().getAvailability() + oldQuantity - quantity);
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        orderItem.getProduct().setAvailability(orderItem.getProduct().getAvailability() + orderItem.getQuantity());
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (salesPrice < product.getPrice()) {
            JOptionPane.showMessageDialog(this, "Price should be more that it is set in the price.");
            return;
        }
        ...
        if (item == null) {
            ...
            if (item.getProduct().getAvailability() + oldQuantity < quantity) {
                JOptionPane.showMessageDialog(this, "Please check product availability.");
                return;
            }

            item.getProduct().setAvailability(item.getProduct().getAvailability() + oldQuantity - quantity);
